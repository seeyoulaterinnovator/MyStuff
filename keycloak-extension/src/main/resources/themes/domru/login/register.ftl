    ...
    <#elseif section = "form">
        <form id="registrationForm" action="${url.registrationAction}" method="post">
            ...
            <div class="flex flex-col justify-between sm:flex-row mt-0 xl:mt-2">
                ...
                <span class="flex-basis-auto ml-0 mb-6 mt-4 text-xs sm:ml-5 sm:mb-0 agreement"><span class="opacity-50">Нажимая кнопку, вы соглашаетесь <br></span><a id="policy" class="reference reference_hoverable" href="https://dom.ru/policy.pdf" target="_blink">с правилами обработки перс. данных</a></span>
            </div>
        </form>
