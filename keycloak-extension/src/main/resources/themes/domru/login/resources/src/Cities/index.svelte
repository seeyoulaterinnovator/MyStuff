...
{#if $showModal}
  <div
    ...
    <div class="flex flex-1 {$status === STATUS.INITIAL ? 'items-center' : ''} justify-center content-box h-full scrollable-container overflow-x-hidden overflow-y-auto mt-4 lg:mt-20 xl:mt-24">
      {#if $status === STATUS.INITIAL}
        <Confirmation />
