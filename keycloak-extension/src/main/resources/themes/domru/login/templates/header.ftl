  ...
  <header id="page-header" class="flex items-center">
    <div class="w-full flex justify-between">
      <a href="${(homePage)!"https://newlkb2b.dom.ru"}">
        <div class="bg-contain bg-no-repeat logo logo--domru"></div>
      </a>
