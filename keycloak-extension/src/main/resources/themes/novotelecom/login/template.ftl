...
>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="${url.resourcesPath}/build/images/favicon-32x32.png" type="image/x-icon">
        <link rel="shortcut icon" href="${url.resourcesPath}/build/images/favicon-16x16.png" type="image/x-icon">
...
<#--        </#if>-->
        ...
        <#if iframe?? && iframe == false>
            <footer id="page-footer" class="w-full flex flex-col footer">
              <a href="${(phoneConstLink)!"tel:83832090909"}" class="show-small-tell highlighted-hover-text highlighted-nested-hover-svg phone-call-center">
