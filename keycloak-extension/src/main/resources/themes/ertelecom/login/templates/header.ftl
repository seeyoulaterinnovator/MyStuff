  ...
  <header id="page-header" class="flex items-center">
    <div class="w-full flex justify-between">
      <a href="https://lkb2b.stelecom.ru">
        <div class="h-30px w-120px md:h-10 md:w-40 xl:h-16 xl:w-40 bg-contain bg-no-repeat logo logo--ertelocom"></div>
      </a>
      <div class="flex items-center xl:items-start">
        <div id="cities-button" class=${withCity ? string("sm:mr-10", "sm:mr-10")} data-city=""></div>

        <a href="tel:88002340880"
...
<#--                    stroke="black"/>-->
<#--            </svg>-->
            <span class="phone-number">8 (800) 234-08-80</span>
          </div>
        </a>
      </div>
    </div>
