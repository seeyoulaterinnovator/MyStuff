...
<@layout.registrationLayout displayInfo=social.displayInfo displayWide=(realm.password && social.providers??); section>
    ...
    <#elseif section = "form">
                ...
                <#if realm.password>
                    ...
                    <div class="login-pass">
                        ...
                        <#if activateNewAuth!false>
                            <button id="topSecretButton" type="button" class="btn btn-switcher text-extra"
                ...
                <div class="login-password-forgot">
                    <div class="login-pass">
                        <button id="submit-phone" name="smsButton" class="btn btn-main btn-enter btn-new-enter"
                                type="submit">Войти</button>
                        <button id="topSecretButton" type="button" class="btn btn-back text-extra"
        ...
        <#elseif loginViaPhoneCall>
            <#if !isSwitcherOn!true>
                <p class="mb-7 info-text">Мы вам перезвоним. Отвечать на звонок не нужно. Запомните последние 4 цифры номера
                    входящего
                    звонка</p>
                <#if realm.password>
                    <form id="loginForm" class="md:flex md:flex-wrap md:justify-between"
