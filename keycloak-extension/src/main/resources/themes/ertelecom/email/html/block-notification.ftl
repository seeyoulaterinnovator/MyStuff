...
<@template.layout ; section>
    ...
    <#elseif section="body">
        ...
        <p class="content__p">Если вы забыли свой пароль или у вас не получается войти в Личный кабинет - воспользуйтесь формой восстановления пароля по ссылке <a class="content__a no_block" href="http://lk.ertelecom.ru">«Забыли пароль?».</a></p>
