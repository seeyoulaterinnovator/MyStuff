...
<@template.layout ; section>
    ...
    <#elseif section="body">
        <p class="content__p">Ваша учетная запись для входа в Личный кабинет «ЕР-Телеком Бизнес» <font color="red" class="text_red">заблокирована</font>. Доступ к услугам при этом не блокируется.</p>
        <p class="content__p">Вы не использовали свою учетную запись в течении длительного времени. Чтобы восстановить доступ к учетной записи, обратитесь к своему персональному менеджеру или оставьте заявку в чате <a class="content__a no_block" href="http://lkb2b.stelecom.ru">Личного кабинета</a>, или по телефону <a class="content__a no_block" href="tel:88003339000">8 800 333 9000</a>.</p>
        ...
        <p class="content__p">Если вы забыли свой пароль или у вас не получается войти в Личный кабинет - воспользуйтесь формой восстановления пароля по ссылке <a class="content__a no_block" href="http://lkb2b.stelecom.ru">«Забыли пароль?»</a></p>
