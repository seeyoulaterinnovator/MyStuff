...
<@template.layout ; section>
    ...
    <#elseif section = "body">
        <p class="content__p">Ваша учетная запись для входа в Личный кабинет «Телеком Центр бизнес» <font color="red" class="text_red">будет заблокирована через ${absence}</font>. Доступ к услугам при этом не блокируется.</p>
