<#macro defaultTemplate withCity=true>
  <header id="page-header" class="flex items-center">
    <div class="w-full flex justify-between">
      <a href="https://lkb2b.stelecom.ru">
      ...
      <div class="flex items-center xl:items-start">
        ...
        <a href="tel:84951459555" class= ${withCity ? string("phone--hidden-small phone-call-center", "phone--hidden-small phone-call-center")}>
          <div class="flex h-6 items-center">
            ...
            <span class="phone-number">+7(495)145 9555</span>
          </div>
        </a>
      </div>
    </div>
