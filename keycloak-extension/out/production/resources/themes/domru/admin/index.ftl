...
<head>
    ...
    <script src="${resourceUrl}/js/controllers/settings.js" type="text/javascript"></script>
    ...
    <script src="${resourceUrl}/js/controllers/realm_ext.js" type="text/javascript"></script>
