var app = (function () {
    ...
    function create_fragment(ctx) {
    	var p, t0, t1, t2, t3, div, button0, t5, button1, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p, file, 18, 2, 412);
    			attr(button0, "class", "btn btn-main mr-8 confirm__btn");
    			add_location(button0, file, 20, 4, 523);
    			attr(button1, "class", "btn disabled confirm__btn");
    			add_location(button1, file, 21, 4, 619);
    			attr(div, "class", "flex confirm__btns");
    			add_location(div, file, 19, 2, 485);
    ...
    function setSelectedCity(selectedCity, selectedDomain) {
      city.set(selectedCity);
      js_cookie.set('CITY', selectedCity);
      js_cookie.set('city-domain', selectedDomain);
    }
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(p, "class", "m-auto");
    			add_location(p, file$1, 118, 6, 3530);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			add_location(div, file$1, 109, 14, 3415);
    		},
    ...
    // (105:11) {#each group.cities as city}
    function create_each_block_2(ctx) {
    	var li, button, t_value = ctx.city.name + "", t, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr(button, "class", "city text-left");
    			add_location(button, file$1, 106, 16, 3271);
    			attr(li, "class", "mb-2 sm:px-2 hover:bg-extra city");
    			add_location(li, file$1, 105, 14, 3208);
    		...
    		p: function update(changed, new_ctx) {
    			ctx = new_ctx;
    			if ((changed.groupedCities) && t_value !== (t_value = ctx.city.name + "")) {
    				set_data(t, t_value);
    			}
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(h2, "class", "text-extra mr-2 capitalize text-left md:text-center mb-2 mbd:mb-0 leading-none w-5 ");
    			add_location(h2, file$1, 99, 10, 2961);
    			attr(ul0, "class", "flex flex-col");
    			add_location(ul0, file$1, 103, 11, 3125);
    			attr(ul1, "class", "flex mb-4 capital flex-col md:flex-row px-0 md:px-2 capital");
    			add_location(ul1, file$1, 98, 8, 2877);
    		},
    ...
    // (95:4) {#each groupedCities as groupPart}
    function create_each_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(ul, file$1, 95, 6, 2791);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(ul, file$1, 93, 0, 2683);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t = space();
    			span = element("span");
    			span.textContent = "8 800 333 9000";
    ...
    function create_if_block(ctx) {
    	var div2, header, div1, a, div0, a_class_value, t0, t1, t2, current_block_type_index, if_block2, div2_class_value, current;
    	...
    	return {
    		c: function create() {
    			...
    			attr(div0, "class", "h-30px w-60px md:h-10 md:w-20 xl:h-16 xl:w-32 bg-contain bg-no-repeat logo logo--domru");
    			add_location(div0, file$3, 49, 10, 1486);
    			attr(a, "href", "https://b2b.domru.ru/");
    			attr(a, "class", a_class_value = ctx.$status === STATUS.SELECTING && 'hidden sm:block');
    			add_location(a, file$3, 48, 8, 1384);
    			attr(div1, "class", "w-full flex justify-between items-center");
    			add_location(div1, file$3, 47, 6, 1320);
    			attr(header, "id", "cities-header");
    			attr(header, "class", "flex items-center pb-4 px-4 sm:px-6 lg:px-8 xl:px-6");
    			add_location(header, file$3, 46, 4, 1225);
    			attr(div2, "class", div2_class_value = "flex flex-col fixed w-screen bg-white inset-0 py-4 md:py-6 xl:py-8 " + (ctx.$status === STATUS.INITIAL && 'opacity-90') + " scrollable-container overflow-x-hidden overflow-y-auto");
    			attr(div2, "id", "location-selection-window");
    			add_location(div2, file$3, 43, 2, 998);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((!current || changed.$status) && div2_class_value !== (div2_class_value = "flex flex-col fixed w-screen bg-white inset-0 py-4 md:py-6 xl:py-8 " + (ctx.$status === STATUS.INITIAL && 'opacity-90') + " scrollable-container overflow-x-hidden overflow-y-auto")) {
    ...
    // (54:8) {#if $status === STATUS.SELECTING}
    function create_if_block_4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(label, "class", "mr-4 hidden lg:block");
    			add_location(label, file$3, 59, 16, 1908);
    			attr(input, "name", "Поиск города");
    			attr(input, "id", "search-city");
    			attr(input, "class", "field__input field__input--city");
    			attr(input, "placeholder", "Выберите город");
    			add_location(input, file$3, 60, 16, 2002);
    			attr(button0, "class", "btn btn-main ml-4 p-3 min-w-0 btn__choose");
    			attr(button0, "type", "submit");
    			add_location(button0, file$3, 67, 16, 2298);
    			attr(div, "class", "field field--row md:w-full items-center");
    			add_location(div, file$3, 58, 14, 1837);
    			add_location(fieldset, file$3, 57, 12, 1811);
    			attr(form, "class", "md:flex md:flex-wrap md:justify-between");
    			add_location(form, file$3, 54, 10, 1673);
    			...
    			add_location(path, file$3, 82, 16, 2770);
    			attr(g, "opacity", "0.5");
    			add_location(g, file$3, 81, 14, 2735);
    			attr(svg, "width", "32");
    			attr(svg, "height", "32");
    			attr(svg, "viewBox", "0 0 32 32");
    			attr(svg, "fill", "none");
    			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$3, 75, 12, 2549);
    			add_location(button1, file$3, 74, 10, 2504);
    ...
    function create_if_block_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div, "class", "flex flex-1 justify-center content-box h-full mt-4 xl:mt-17 scrollable-container overflow-x-hidden overflow-y-auto custom-scroll");
    			add_location(div, file$3, 106, 10, 3628);
    		},
    ...
    // (102:6) {#if $status === STATUS.INITIAL}
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div, "class", "flex flex-1 items-center justify-center content-box h-full mt-4 xl:mt-17 custom-scroll flex-col");
    			add_location(div, file$3, 102, 10, 3410);
    		},

    		m: function mount(target, anchor) {
    			insert(target, div, anchor);
    			mount_component(confirmation, div, null);
    			current = true;
    		},
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(confirmation);
    		}
    	};
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(path, file$4, 24, 6, 616);
    			attr(circle, "cx", "8");
    			attr(circle, "cy", "7");
    			attr(circle, "r", "1");
    			attr(circle, "fill", "black");
    			add_location(circle, file$4, 33, 6, 1146);
    			attr(g, "opacity", "0.5");
    			add_location(g, file$4, 23, 4, 591);
    			attr(svg, "class", "h-8 w-auto mr-1 outline-none city-icon");
    			attr(svg, "width", "16");
    			attr(svg, "height", "16");
    			attr(svg, "viewBox", "0 0 16 16");
    			attr(svg, "fill", "none");
    			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
    			add_location(svg, file$4, 16, 2, 413);
    			attr(span, "class", "border-dashed border-b border-main-600 h-6 leading-normal");
    			add_location(span, file$4, 36, 2, 1213);
    			attr(button, "class", "flex focus:outline-none h-6 items-center");
      ...
      if (location.search.indexOf('city') > 0) {
        ...
        axios$1
          ...
          .then(response => {
            ...
            if (cityName) {
              if (cityName.bss) {
                js_cookie.set('CITY', cityName.name);
                js_cookie.set('city-domain', detectedCity);
                city.set(cityName.name);
              } else {
    ...
    */
    ...
    const WRONG_PASS_REG = /([^A-Za-z0-9_\-\[\].!#]+)/g;

    const REQUIRED_PASSWORD = /(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[\[\-_._!#\]])([0-9a-zA-Z\[\-_._!#\]]){8,16}/;
    ...
    ((function() {
      ...
      formElement.addEventListener('submit', () => {
        ...
        cityElement.value = js_cookie.get('city-domain') || 'perm';
        return true;
      });
    ...
    var iframeResizer_contentWindow_min = createCommonjsModule(function (module) {
