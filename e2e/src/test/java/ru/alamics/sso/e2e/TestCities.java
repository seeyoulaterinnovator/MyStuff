...
@ExtendWith(TestCities.WaitOnFailExtension.class)
@Testcontainers
@Slf4j
public class TestCities {
    ...
    void getCities() {
        ...
        given()
                ...
                .get("http://localhost:8080/auth/realms/{realm}/cities")
                .then()
    ...
    void currentCities() {
        ...
        given()
                .pathParam("realm", realm)
                .get("http://localhost:8080/auth/realms/{realm}/cities/current")
                .then()
                .log()
                .body()
