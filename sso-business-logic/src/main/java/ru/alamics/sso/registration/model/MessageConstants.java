...
public class MessageConstants {
    ...
    public static final String SMS_LIMIT_20_BLOCK = "Превышен лимит СМС. Запросить новое СМС можно через 12 часов";
    public static final String SMS_LIMIT_5_CONTINUE = "Код был введён более 5 раз. Запросите новое СМС";
    public static final String CALL_LIMIT_20_BLOCK = "Превышен лимит повторных звонков. Запросить новый звонок можно через 12 часов";
