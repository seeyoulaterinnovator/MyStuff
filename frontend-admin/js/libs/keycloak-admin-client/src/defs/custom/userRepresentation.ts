...
export type ArrayTimeRepresentation = [number, number, number, number, number, number];
...
export interface UsersResponseRepresentation extends Response<UsersRepresentation> {}
