...
/**
 * @see io.undertow.server.handlers.RequestDumpingHandler;
 */
public class FixedRequestDumpingHandler implements HttpHandler {

    private final HttpHandler next;

    public FixedRequestDumpingHandler(final HttpHandler next) {
        this.next = next;
    }
    ...
    public void handleRequest(final HttpServerExchange exchange) throws Exception {
        ...
        exchange.addExchangeCompleteListener(new ExchangeCompletionListener() {
            ...
            public void exchangeEvent(final HttpServerExchange exchange, final NextListener nextListener) {
                ...
                String storedResponse = FixedStoredResponse.INSTANCE.readAttribute(exchange);
    ...
    private static class Wrapper implements HandlerWrapper {
        ...
        public HttpHandler wrap(HttpHandler handler) {
            return new FixedRequestDumpingHandler(handler);
        }
    }
}
